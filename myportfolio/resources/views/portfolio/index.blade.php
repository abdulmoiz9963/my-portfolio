    ...
    <div class="hero-container">
        <div class="hero-text">
            ...
            <div class="hero-socials">
                <a href="https://www.linkedin.com/in/abdulmoiz-ashraf-b2997a206" target="_blank" class="social-link"><i class="fab fa-linkedin"></i></a>
                <a href="https://github.com/abdulmoiz9963" target="_blank" class="social-link"><i class="fab fa-github"></i></a>
                <a href="mailto:{{ $profile->email ?? 'moiz9963@gmail.com' }}" class="social-link"><i class="fas fa-envelope"></i></a>
            </div>
        </div>
        <div class="hero-image">
            <div class="image-frame">
                @if($profile && $profile->profile_image)
                    <img src="{{ asset('storage/' . $profile->profile_image) }}" alt="{{ $profile->name }}" class="profile-img">
                @else
        ...
        <div class="about-grid">
            <div class="about-image-col">
                <div class="about-img-wrap">
                    @if($profile && $profile->profile_image)
                        <img src="{{ asset('storage/' . $profile->profile_image) }}" alt="{{ $profile->name }}" class="about-img">
                    @else
    ...
    <div class="container">
        ...
        <div class="skills-grid">
            ...
            <div class="skill-card reveal">
                ...
                <div class="skill-tags">
                    <span class="skill-tag">EC2</span><span class="skill-tag">IAM</span>
                    <span class="skill-tag">VPC</span><span class="skill-tag">ECR</span>
                    <span class="skill-tag">Lambda</span><span class="skill-tag">API Gateway</span>
                    <span class="skill-tag">DynamoDB</span><span class="skill-tag">CloudWatch</span>
                    <span class="skill-tag">S3</span><span class="skill-tag">Route 53</span>
                    <span class="skill-tag">Auto Scaling</span><span class="skill-tag">ALB</span>
                </div>
            </div>
            <div class="skill-card reveal">
                <div class="skill-card-header">
    ...
    <div class="container">
        ...
        <div class="timeline">
            ...
            <div class="timeline-item reveal">
                ...
                <div class="timeline-card">
                    <div class="timeline-meta">
                        <span class="timeline-date"><i class="fas fa-calendar"></i> {{ $exp->start_date }} — {{ $exp->end_date ?? 'Present' }}</span>
            ...
            <div class="timeline-item reveal">
                ...
                <div class="timeline-card">
                    <div class="timeline-meta">
                        <span class="timeline-date"><i class="fas fa-calendar"></i> June 2025 — Present</span>
                    ...
                    <div class="timeline-tags">
                        <span class="tech-tag">AWS</span><span class="tech-tag">Terraform</span>
                        <span class="tech-tag">GitHub Actions</span><span class="tech-tag">ECS</span>
                        <span class="tech-tag">Lambda</span><span class="tech-tag">DynamoDB</span>
                        <span class="tech-tag">CloudWatch</span><span class="tech-tag">IAM</span>
                    </div>
                </div>
            </div>
            <div class="timeline-item reveal">
                ...
                <div class="timeline-card edu-card">
                    <div class="timeline-meta">
                        <span class="timeline-date"><i class="fas fa-calendar"></i> 2021 — 2025</span>
        ...
        <div class="projects-grid">
            ...
            <div class="project-card reveal">
                ...
                <div class="project-img-wrap">
                    ...
                    <div class="project-overlay">
                        <div class="project-links">
                            @if($project->live_url)
                            <a href="{{ $project->live_url }}" target="_blank" class="proj-link"><i class="fas fa-external-link-alt"></i></a>
                            @endif
                            @if($project->github_url)
                            <a href="{{ $project->github_url }}" target="_blank" class="proj-link"><i class="fab fa-github"></i></a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="project-body">
                    ...
                    <div class="project-footer">
                        @if($project->live_url)
                        <a href="{{ $project->live_url }}" target="_blank" class="btn-proj">Live Demo <i class="fas fa-arrow-right"></i></a>
                        @endif
                        @if($project->github_url)
                        <a href="{{ $project->github_url }}" target="_blank" class="btn-proj-ghost"><i class="fab fa-github"></i> Code</a>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="project-card reveal featured">
                <div class="project-body">
                    ...
                    <p class="project-desc">A full-stack travel planning web application with complete CI/CD pipeline. Built with React.js frontend, Node.js API, MySQL database. Containerized with Docker and deployed on AWS EC2 with NGINX reverse proxy, HTTPS via Let's Encrypt SSL, and Route 53 domain configuration. Integrated Jenkins for CI/CD, SonarQube for code quality, and CloudWatch for monitoring.</p>
                    <div class="project-stack">
                        <span class="stack-tag">React.js</span><span class="stack-tag">Node.js</span>
                        <span class="stack-tag">MySQL</span><span class="stack-tag">Docker</span>
                        <span class="stack-tag">Jenkins</span><span class="stack-tag">NGINX</span>
                        <span class="stack-tag">AWS EC2</span><span class="stack-tag">ECR</span>
                        <span class="stack-tag">Route 53</span><span class="stack-tag">Auto Scaling</span>
                        <span class="stack-tag">CloudWatch</span><span class="stack-tag">SonarQube</span>
                    </div>
                </div>
            </div>
            @endforelse
                ...
                <div class="contact-items">
                    <div class="contact-item">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $profile->email ?? 'moiz9963@gmail.com' }}" class="contact-value">{{ $profile->email ?? 'moiz9963@gmail.com' }}</a>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            ...
                            <a href="tel:{{ $profile->phone ?? '03111458114' }}" class="contact-value">{{ $profile->phone ?? '03111458114' }}</a>
                        </div>
                    </div>
                    <div class="contact-item">
                        ...
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/abdul-moiz-ashraf-b2997a206" target="_blank" class="contact-value">abdulmoiz-ashraf</a>
                        </div>
                    </div>
                    <div class="contact-item">
